        ...
        <Typography>{product.title.longTitle}</Typography>
                <Typography style ={{ marginTop: 5, color: '#878787', fontSize: 14 }}>
                    ...
                    <SmallText>
                        ...
                        <Typography><StyledBadge />5% Cashback on Flipkart on Axis Bank Card</Typography>
                        <Typography><StyledBadge />No cost EMI in Bajaj Finserv EMI card on cart  vallue above ₹2999 T&C </Typography>
                    </SmallText>
                    <Table>
                        <TableBody>
                            <ColumnText>
